import { UserConflictError, UserInternalError, UserNotFoundError } from "./shared/errors.js";
import { Context, Effect, Layer, Option } from "effect";
import type { UserRepositoryError } from "./shared/errors.js";
import type { UserCreateInput, UserUpdateInput } from "./shared/types.js";
...
>() {
  ...
  static readonly Live = Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      // Replace this with: return createUserRepository(database, logger);
      return createUserRepository(undefined as any, undefined);
    })
  );
  ...
  static readonly Dev = Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      // For now, create repository without dependencies (update when ready)
      const repo = createUserRepository(undefined as any, undefined);
