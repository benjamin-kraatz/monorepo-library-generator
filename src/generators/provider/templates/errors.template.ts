 ...
 */
export function generateErrorsFile(options: ProviderTemplateOptions): string {
  ...
  builder.addRaw(" */")
  builder.addRaw(`export class ${className}ApiError extends Data.TaggedError("${className}ApiError")<{`)
  builder.addRaw("  readonly message: string;")
  ...
  builder.addRaw(" */")
  builder.addRaw(`export class ${className}ConnectionError extends Data.TaggedError("${className}ConnectionError")<{`)
  builder.addRaw("  readonly message: string;")
  builder.addRaw("  readonly cause?: unknown;")
  builder.addRaw("}> {}")
  builder.addBlankLine()
  ...
  builder.addRaw(" */")
  builder.addRaw(`export class ${className}RateLimitError extends Data.TaggedError("${className}RateLimitError")<{`)
  builder.addRaw("  readonly message: string;")
  ...
  builder.addRaw(" */")
  builder.addRaw(`export class ${className}ValidationError extends Data.TaggedError("${className}ValidationError")<{`)
  builder.addRaw("  readonly message: string;")
  ...
  builder.addRaw(" */")
  builder.addRaw(`export class ${className}TimeoutError extends Data.TaggedError("${className}TimeoutError")<{`)
  builder.addRaw("  readonly message: string;")
  ...
  builder.addRaw(" */")
  builder.addRaw(`export function map${className}Error(error: unknown): ${className}Error {`)
  builder.addRaw("  // Safe property access")
  builder.addRaw("  const message = Reflect.get(error as object, \"message\");")
  builder.addRaw("  const statusCode = Reflect.get(error as object, \"statusCode\");")
  ...
  builder.addRaw("    const retryAfter = Reflect.get(error as object, \"retryAfter\");")
  ...
  builder.addRaw("      retryAfter: typeof retryAfter === \"number\" ? retryAfter : undefined,")
  builder.addRaw("    });")
  builder.addRaw("  }")
  builder.addBlankLine()
  ...
  builder.addRaw("      errorCode: typeof code === \"string\" ? code : undefined,")
  builder.addRaw("      cause: error,")
  builder.addRaw("    });")
  builder.addRaw("  }")
  builder.addBlankLine()
