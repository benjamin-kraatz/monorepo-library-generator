...
export function generateEntitiesFile(options: ContractTemplateOptions): string {
  ...
  builder.addFileHeader({
    ...
    description:
      "Defines domain entities using Schema.Class for runtime validation. Database types are imported from @creativetoolkits/types-database.",
    module: `@creativetoolkits/contract-${fileName}/entities`
  })
...
`)
  ...
  builder.addComment("Import database-generated types from types-database library")
  ...
  builder.addComment("} from \"@creativetoolkits/types-database\";")
  builder.addBlankLine()
