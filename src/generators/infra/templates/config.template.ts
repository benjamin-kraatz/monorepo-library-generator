 ...
 */
export function generateConfigFile(options: InfraTemplateOptions): string {
  ...
  builder.addFileHeader({
    ...
    module: `@creativetoolkits/infra-${fileName}/config`,
...
export const production${className}Config: ${className}Config = {
  ...
  builder.addFunction({
    ...
    params: [
      { name: "env", type: "string", defaultValue: "process.env[\"NODE_ENV\"] || 'development'" }
    ],
