...
describe("Data Access Library Generator", () => {
  ...
  describe("Phase 1: Foundation", () => {
    ...
    it("should generate package.json with correct metadata", async () => {
      ...
      expect(packageJson.name).toBe("@creativetoolkits/data-access-product");
  ...
  describe("Phase 2: Repository Pattern", () => {
    it("should generate repository implementation in single file", async () => {
      ...
      const content =
        tree.read(`${projectRoot}/src/lib/repository.ts`, "utf-8") || "";
    ...
    it("should generate server-side layers in lib/server/layers.ts", async () => {
      ...
      expect(tree.exists(`${projectRoot}/src/lib/server/layers.ts`)).toBe(
        true
      );

      const content =
        tree.read(`${projectRoot}/src/lib/server/layers.ts`, "utf-8") || "";
  ...
  describe("Phase 3: Shared Layer", () => {
    it("should generate Data.TaggedError error types", async () => {
      ...
      expect(tree.exists(`${projectRoot}/src/lib/shared/errors.ts`)).toBe(
        true
      );

      const content =
        tree.read(`${projectRoot}/src/lib/shared/errors.ts`, "utf-8") || "";
    ...
    it("should generate shared types (entity, filters, pagination)", async () => {
      ...
      const content =
        tree.read(`${projectRoot}/src/lib/shared/types.ts`, "utf-8") || "";
    ...
    it("should generate validation helpers", async () => {
      ...
      const content =
        tree.read(`${projectRoot}/src/lib/shared/validation.ts`, "utf-8") ||
        "";
    ...
    it("should have consistent naming across shared layer", async () => {
      ...
      const errorContent =
        tree.read(`${paymentRoot}/src/lib/shared/errors.ts`, "utf-8") || "";
      ...
      const typeContent =
        tree.read(`${paymentRoot}/src/lib/shared/types.ts`, "utf-8") || "";
  ...
  describe("Phase 4: Query Builders", () => {
    it("should generate queries.ts with Kysely query builders", async () => {
      ...
      const content =
        tree.read(`${projectRoot}/src/lib/queries.ts`, "utf-8") || "";
      ...
      const hasCountQuery =
        content.includes("buildCountQuery") || content.includes("countQuery");
  ...
  describe("Phase 5: File Structure", () => {
    it("should have correct source directory structure", async () => {
      ...
      expect(tree.exists(`${projectRoot}/src/lib/repository/interface.ts`)).toBe(false);
    ...
    it("should generate layer composition tests", async () => {
      ...
      const content =
        tree.read(`${projectRoot}/src/lib/layers.spec.ts`, "utf-8") || "";
    ...
    it("should generate repository unit tests", async () => {
      ...
      const content =
        tree.read(`${projectRoot}/src/lib/repository.spec.ts`, "utf-8") || "";
    ...
    it("should not have incomplete EJS placeholders", async () => {
      ...
      const hasImplementation =
        repositoryContent.includes("function") ||
    ...
    it("should support multi-word domain names", async () => {
      ...
      expect(packageJson.name).toBe(
        "@creativetoolkits/data-access-payment-gateway"
      );
    });
  ...
  describe("Integration", () => {
    ...
    it("should have consistent repository method signatures", async () => {
      ...
      const hasEffectUsage =
        repositoryContent.includes("Effect.gen") ||
  ...
  describe("Naming Conventions", () => {
    it("should convert domain names to proper naming variants", async () => {
      ...
      const repositoryContent =
        tree.read(`${paymentRoot}/src/lib/repository.ts`, "utf-8") || "";
    ...
    it("should use consistent naming across all generated files", async () => {
      ...
      const repositoryContent =
        tree.read(`${userRoot}/src/lib/repository.ts`, "utf-8") || "";
      expect(repositoryContent).toContain("UserProfileRepository");

      // Errors should use PascalCase
      const errorContent =
        tree.read(`${userRoot}/src/lib/shared/errors.ts`, "utf-8") || "";
      ...
      const typeContent =
        tree.read(`${userRoot}/src/lib/shared/types.ts`, "utf-8") || "";
