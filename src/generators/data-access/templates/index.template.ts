...
Repository implements contract from @creativetoolkits/contract-${fileName}`,
    module: `@creativetoolkits/data-access-${fileName}`
  })
  ...
  builder.addComment(`OLD: import { ${className}RepositoryLive } from "@creativetoolkits/data-access-${fileName}";`)
  builder.addComment(`NEW: import { ${className}Repository } from "@creativetoolkits/data-access-${fileName}";`)
